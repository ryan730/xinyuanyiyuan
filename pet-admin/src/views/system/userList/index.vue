...
const timerValue = ref(undefined);
...
const handleDownLoad = async () => {
  ...
  const res = (await ListService.downLoad({ type:"userlist",...timer })) as any;
...
const getUserList = async (date: any = {}) => {
  ...
  const res = (await ListService.userList({ page: searchForm.pageNum, ...timer })) as any;
